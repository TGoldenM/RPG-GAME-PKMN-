...
if(isset($_SESSION['gymObj'])){
    $gym = unserialize($_SESSION['gymObj']);
    unset($_SESSION['gymObj']);
} else {
    if($is_new){
        $gym = (object)array(
            "id" => null,
...
<html>
    <head>
        ...
        <script type="text/javascript" src="javascript/gymEdit.js"></script>
    </head>
    ...
    <body>
        <div class="wrap">
            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="header"><?php echo $is_new ? 'New' : 'Edit' ?> gym</div>
                    <?php
                    ...
                    <div style="padding: 5px;">
                        <form id="formData" action="proc_data/proc_gym.php"
                              method="post">
                            <?php
                            if(!$is_new){
                                echo "<input type='hidden' id='id' name='id' value='$gym->id' />";
                            ...
                            <table class="pkmn_form">
                                ...
                                <tr>
                                    ...
                                    <td class="value">
                                        ...
                                        genSelectOptions('pkmn_region', 'id', 'name'
                                                , $gym->id_region, null, null, 'name');
