    ...
    <body>
        <div class="wrap">
            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="header">Players with highest victory count</div>
                    <?php
                        ...
                        <form action="userAdmin.php" method="post">
                            <table style="width: 100%;" class="data_table">
                                <tr class="header">
                                    ...
                                    <td class="colWidth2">Victories</td>
                                    <td class="colWidth2">Defeats</td>
                                <?php
                                foreach ($ranking as $r) {
                                    echo "<tr><td>$r->username</td>
                                          <td>$r->victories</td><td>$r->defeats</td>
                                          </tr>";
                                }
                                ?>
                            </table>
