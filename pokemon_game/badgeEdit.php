...
if(isset($_SESSION['badgeObj'])){
    $badge = unserialize($_SESSION['badgeObj']);
    unset($_SESSION['badgeObj']);
} else {
    if($is_new){
        $badge = (object)array(
            "id" => null,
...
<html>
    <head>
        ...
        <script type="text/javascript" src="javascript/badgeEdit.js"></script>
    </head>
    ...
    <body>
        <div class="wrap">
            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="header"><?php echo $is_new ? 'New' : 'Edit' ?> badge</div>
                    <?php
                    ...
                    <div style="padding: 5px;">
                        <form id="formData" action="proc_data/proc_badge.php"
                              method="post" enctype="multipart/form-data">
                            <?php
                            if(!$is_new){
                                echo "<input type='hidden' id='id' name='id' value='$badge->id' />";
                            ...
                            <table class="pkmn_form">
                                ...
                                if (!$is_new) {
                                    echo "<tr><td class='label'>Current Image:</td>
                                        <td><img src='proc_data/proc_badge.php?action=img&id=$badge->id&w=22&h=22' />
                                        </td></tr>";
                                }
                                ?>
