...
if(isset($_SESSION['roleObj'])){
    $role = unserialize($_SESSION['roleObj']);
    unset($_SESSION['roleObj']);
} else {
    if($is_new){
        $role = (object)array(
            "id" => null,
...
<html>
    <head>
        ...
        <script type="text/javascript" src="javascript/roleEdit.js"></script>
    </head>
    ...
    <body>
        <div class="wrap">
            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="header"><?php echo $is_new ? 'New' : 'Edit' ?> role</div>
                    <?php
                    ...
                    <div style="padding: 5px;">
                        <form id="formData" action="proc_data/proc_role.php"
                              method="post">
                            <?php
                            if(!$is_new){
                            ...
                            <table class="pkmn_form">
                                <tr>
                                    ...
                                    <td class="value">
                                        <input class='number' type='text' id='rank' name='rank'
                                               value='<?php echo $role->rank ?>' />
                                    </td>
                                </tr>
                                <tr>
