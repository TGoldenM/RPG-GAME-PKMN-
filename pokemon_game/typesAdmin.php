            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div style="padding: 5px;">
                        <div class="pkmn_ctrl">
                            <a href="typesEdit.php">Add</a>
                        </div>
                        
                        <form action="typesAdmin.php" method="post">
                            <?php if (count($list) > 0) :?>
                            ...
                            <table style="width: 100%;" class="data_table">
                                ...
                                foreach ($list as $obj) {
                                    ...
                                    echo "<td>"
                                        . "<a href='typesEdit.php?id=$obj->id'>"
                                        . "<img src='images/menu_icons/pencil.png' alt='edit' /></a>"
                                        . "<a href='typeEffects.php?id=$obj->id'>"
