...
<html>
    <head>
        ...
        <script type="text/javascript" src="javascript/regionAdmin.js"></script>
    </head>
            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div style="padding: 5px;">
                        <div class="pkmn_ctrl">
                            <a href="regionEdit.php">Add</a>
                        </div>
                        
                        <form action="regionAdmin.php" method="post">
                            <?php if (count($list) > 0) :?>
                            ...
                            <table style="width: 100%;" class="data_table">
                                ...
                                foreach ($list as $obj) {
                                    ...
                                    echo "<td><a id='obj_$obj->id' href='proc_data/proc_region.php?action=delete&id=$obj->id&btnYes=1'><img src='images/menu_icons/erase.png' alt='Delete'/></a>"
                                        . "&nbsp;<a href='regionEdit.php?id=$obj->id'>"
