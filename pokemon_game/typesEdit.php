...
if(isset($_SESSION['typeObj'])){
    $type = unserialize($_SESSION['typeObj']);
    unset($_SESSION['typeObj']);
} else {
    if($is_new){
        $type = (object)array(
            "id" => null,
...
<html>
    <head>
        ...
        <script type="text/javascript" src="javascript/typesEdit.js"></script>
    </head>
            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div style="padding: 5px;">
                        <form id="formData" action="proc_data/proc_pokemon_type.php"
                              method="post">
                            <?php
                            if(!$is_new){
                                echo "<input type='hidden' id='id' name='id' value='$type->id' />";
