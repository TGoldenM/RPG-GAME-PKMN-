...
if(isset($_SESSION['regionObj'])){
    $region = unserialize($_SESSION['regionObj']);
...
<html>
    <head>
        ...
        <script type="text/javascript" src="javascript/regionEdit.js"></script>
    </head>
    ...
    <body>
        <div class="wrap">
            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="header"><?php echo $is_new ? 'New' : 'Edit' ?> region</div>
                    <?php
                    ...
                    <div style="padding: 5px;">
                        <form id="formData" action="proc_data/proc_region.php"
                              method="post">
                            <?php
                            if(!$is_new){
                                echo "<input type='hidden' id='id' name='id' value='$region->id' />";
