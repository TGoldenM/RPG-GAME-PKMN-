...
$ranking = getRankingTrainerCurrency();
?>
    ...
    <body>
        <div class="wrap">
            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="header">Players with highest economic value</div>
                    <?php
                        ...
                        <form action="userAdmin.php" method="post">
                            <table style="width: 100%;" class="data_table">
                                <tr class="header">
                                    ...
                                    <td class="colWidth2">Gold</td>
                                    <td class="colWidth2">Silver</td>
                                <?php
                                foreach ($ranking as $r) {
                                    echo "<tr><td>$r->username</td>
                                          <td>$r->gold</td><td>$r->silver</td>
                                          </tr>";
                                }
                                ?>
                            </table>
